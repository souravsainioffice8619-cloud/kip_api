...
least_frequent_repairs_router = APIRouter(prefix="/kpi")


@least_frequent_repairs_router.get("/least_frequent_repairs")
def get_least_frequent_repairs(request: Request, limit: int | None = Query(default=5)):
    """Top least frequent repair types."""
