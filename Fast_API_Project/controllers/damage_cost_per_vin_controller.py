...
damage_cost_per_vin_router = APIRouter(prefix="/kpi")


@damage_cost_per_vin_router.get("/damage_cost/vin")
...
@damage_cost_per_vin_router.get("/damage_cost/vin/weekly")
